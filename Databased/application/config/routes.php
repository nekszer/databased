...
$route['revisions/loadRecordRevisions/(.+?)/(.+?)/(.+?)/(.+?)'] = 'revisions/loadRecordRevisions/$1/$2/$3/$4';
...
$route['revisions/(.+?)/(.+?)/(.+?)/(.+?)/(.+?)'] = 'revisions/index/$1/$2/$3/$4/$5';

$route['db/saveField/(.+?)/(.+?)/(.+?)'] = 'db/saveField/$1/$2/$3';
$route['db/addField/(.+?)'] = 'db/addField/$1';
$route['db/removeField/(.+?)'] = 'db/removeField/$1';
$route['db/newRecord/(.+?)/(.+?)'] = 'db/newRecord/$1/$2';
$route['db/getRecord/(.+?)/(.+?)/(.+?)'] = 'db/getRecord/$1/$2/$3';
$route['db/getCell/(.+?)/(.+?)/(.+?)/(.+?)'] = 'db/getCell/$1/$2/$3/$4';
$route['db/deleteRecord/(.+?)/(.+?)/(.+?)'] = 'db/deleteRecord/$1/$2/$3';
$route['db/updateRecord/(.+?)/(.+?)/(.+?)/(.+?)'] = 'db/updateRecord/$1/$2/$3/$4';
$route['db/deleteTable/(.+?)/(.+?)'] = "db/deleteTable/$1/$2";
$route['db/newTable/(.+?)'] = "db/newTable/$1";
$route['db/updateTable/(.+?)/(.+?)'] = "db/updateTable/$1/$2";
$route['db/uploadCsv/(.+?)'] = "db/uploadCsv/$1";
...
//$route['redactorUpload'] = "redactorUpload/index";
