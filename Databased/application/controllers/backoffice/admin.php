...
class Admin extends CI_Controller {
	...
	*/
	...
	public function db()
	{
		...
		$this->load->view("backoffice/admin/db", $this->data);
	...
	*/
	...
	public function newDB()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			redirect("backoffice/admin/db/", "refresh");
	...
	*/
	...
	public function files()
	{
		...
		$subfolder = parse_url(base_url('backoffice'), PHP_URL_PATH);	
		$subfolder = rtrim($subfolder, "/");
		
		//get all files
		$this->data['files'] = get_dir_file_info( $_SERVER['DOCUMENT_ROOT'].$subfolder.'/uploads/' );
				
		$this->load->view("backoffice/admin/files", $this->data);
	...
	*/
	...
	public function deleteFile($file = '')
	{
		...
		redirect("backoffice/admin/files/", "refresh");
