    		...
    		<div class="col-md-3 visible" id="sidebar">
    			...
    			<ul class="nav nav-list margin-bottom-20">
    			    ...
    			    <li <?php if(isset($theUser) && $theUser->user_id == $user->id):?>class="active"<?php endif;?>>
    			    	<a href="<?php echo site_url('backoffice/users/'.$user->id);?>">
    		...
    		<div class="col-md-9" id="mainContent">
    			...
    			<div class="tab-content">
    				...
    				<div class="tab-pane fade in active" id="tab1">
    			    	...
    			    	<form class="form-horizontal" role="form" action="<?php echo site_url('backoffice/users/updateLogin/'.$theUser->user_id);?>" method="post">
    			    	...
    			    	<form class="form-horizontal" role="form" action="<?php echo site_url('backoffice/users/update/'.$theUser->user_id);?>" method="post">
    			    		<input type="hidden" name="_token" value="<?php echo $this->session->userdata('session_id');?>">
    			    		<div class="form-group">
    				...
    				<div class="tab-pane fade" id="tab2">
    					...
    					<div class="alert">
    						...
    						<a href="<?php echo site_url('backoffice/users/delete/'.$theUser->user_id);?>" class="btn btn-danger btn-embossed"><span class="fui-cross-inverted"></span> <?php echo $this->lang->line('users_user_more_actions_button_delete')?></a>
    					</div>
