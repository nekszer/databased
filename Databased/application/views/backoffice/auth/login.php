    ...
    <div class="container main">
    	...
    	<div class="row">
    		...
    		<div class="col-md-offset-4 col-md-4">
    			...
    			<form action="<?php echo site_url('backoffice/auth/login');?>" method="post">
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="email" id="identity" name="identity" placeholder="<?php echo $this->lang->line('login_email_label')?>" class="form-control">
    					</div>
    				</div>
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="password" id="password" name="password" placeholder="<?php echo $this->lang->line('login_pw_label')?>" class="form-control">
    					</div>
    				</div>
    				...
    				<button type="submit" class="btn btn-primary btn-embossed btn-block margin-top-20"><?php echo $this->lang->line('login_button')?></button>
    					
    			</form>
    			
    			<p class="text-center margin-top-10">
    				<a href="forgot_password" class="small"><?php echo $this->lang->line('login_forgot_your_password');?></a>
    			</p>
