    ...
    <div class="container main">
    	...
    	<div class="row">
    		...
    		<div class="col-md-offset-4 col-md-4">
    			...
    			<p class="text-center"><?php echo sprintf( $this->lang->line('forgotpassword_heading'), $identity_label);?></p>
    					
    			<form action="<?php echo site_url('backoffice/auth/forgot_password');?>" method="post">
    				...
    				<div class="form-group">
    					<div class="input-group">
    						...
    						<input type="email" id="email" name="email" placeholder="<?php echo $this->lang->line('forgotpassword_email_label')?>" class="form-control">
    					</div>
    				</div>
    					  	    			
    				<button type="submit" class="btn btn-primary btn-embossed btn-block margin-top-20"><?php echo $this->lang->line('forgotpassword_button')?></button>
