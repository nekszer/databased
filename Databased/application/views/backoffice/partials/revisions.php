      		...
      		<div class="panel-body clearfix">
        		...
        		<div class="row">
        			...
        			<div class="col-md-4 text-left">
        				<a href="<?php echo site_url('backoffice/revisions/viewRecord/'.$db."/".$table."/".$indexName."/".$recordID."/".$revision->dbapp_cellrevisions_timestamp);?>" target="_blank" class="btn btn-inverse tt" data-placement="right" title="Click to show the entire value in a new window"><span class="fui-export"></span></a>
        			</div>
