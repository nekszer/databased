...
<body>
    		...
    		<div class="col-md-3 visible" id="sidebar">
    			...
    			<ul class="nav nav-list margin-bottom-20">
    			    ...
    			    <li <?php if(isset($theRole) && $theRole->name == $role->name):?>class="active"<?php endif;?>>
    			    	<a href="<?php echo site_url('backoffice/roles/'.$role->name);?>">
    		...
    		<div class="col-md-9" id="mainContent">
    			...
    			<div class="tab-content">
    				...
    				<div class="tab-pane active" id="permissionTab">
    					...
    					<form action="<?php echo site_url('backoffice/roles/update');?>" method="post">
    				...
    				<?php if($theRole->name != 'Administrator'):?>
   					<div class="tab-pane" id="moreTab">
   						...
   						<form class="form-horizontal" role="form" action="<?php echo site_url('backoffice/roles/update');?>" method="post">
   							<input type="hidden" name="_token" value="<?php echo $this->session->userdata('session_id');?>">
   							<input type="hidden" name="roleID" value="<?php echo $theRole->id;?>">
   							<div class="form-group">
   						...
   						<div class="alert">
   							...
   							<?php if( isset($defaultRole) && $theRole->id != $defaultRole->id ):?>
   								...
   								<a href="<?php echo site_url('backoffice/roles/delete/'.$theRole->id);?>" class="btn btn-danger btn-embossed"><?php echo $this->lang->line('roles_delete_message_confirm')?></a>
   							<?php else:?>
    ...
    <?php $this->load->view("backoffice/roles/includes/modal_newrole");?>
