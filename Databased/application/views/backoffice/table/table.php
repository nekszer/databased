    		...
    		<div class="col-md-12" id="mainContent">
    			...
    			<div class="tab-content">
    			    ...
    			    <div class="tab-pane fade" id="tab2">
    			    	...
    			    	<?php $this->load->view("backoffice/partials/column_table", $cData);?>
    			    ...
    			    <div class="tab-pane fade" id="tab3">
    			    	...
    			    	<div class="thetablenotes">
    			    		...
    			    		<div id="tableNotes">
    			    			...
    			    			<?php $this->load->view("backoffice/partials/tablenotes", array('tableNotes'=>$tableNotes));?>
    			    ...
    			    <div class="tab-pane fade" id="tab4">
    			    	...
    			    	<div class="alert alert-error">
    			    		<button type="button" class="close fui-cross" data-dismiss="alert"></button>
    			    	  	...
    			    	  	<a href="<?php echo site_url('backoffice/db/deleteTable/'.$theDB."/".$theTable);?>" class="btn btn-danger btn-wide" id="deleteTableLink"><?php echo $this->lang->line('table_more_delete_button')?></a>
    			    	</div><!-- /.alert -->
    			    	...
    			    	<div class="row">
    			    		...
    			    		<div class="col-md-9">
    			    			...
    			    			<form action="<?php echo site_url('backoffice/db/updateTable/'.$theDB."/".$theTable);?>" method="post" class="form-horizontal">
    ...
    <div class="bottomTabs">
    	...
    	<ul>
    		...
    		<li <?php if($table['table'] == $theTable):?>class="active"<?php endif;?>>
    			<a href="<?php echo site_url('backoffice/db/'.$theDB."/".$table['table']);?>"><?php echo $table['table'];?></a>
    		</li>
    		<?php endforeach;?>
    	</ul>	
