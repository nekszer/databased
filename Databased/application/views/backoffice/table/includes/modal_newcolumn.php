<!-- Modal -->
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('backoffice/columns/addColumn/'.$theDB."/".$theTable);?>" id="newColumnForm">
      			    ...
      			    <div class="tab-pane fade" id="newColumnModal_tab2">
      			    	...
      			    	<div class="alert alert-info">
      			    		<button type="button" class="close fui-cross" data-dismiss="alert"></button>
      			    	  	...
      			    	  	<a href="<?php echo site_url('backoffice/doc/columnrestrictions');?>" class="btn btn-info btn-wide" target="_blank"><?php echo $this->lang->line('table_popup_column_retrictions_message_button')?> <span class="fui-export"></span></a>
      			    	</div>
      			    
      			    	<?php $this->load->view("backoffice/partials/columnrestrictions");?>
