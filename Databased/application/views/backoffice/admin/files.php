    ...
    <div class="container main extra-top-padding">
    	...
    	<div class="row">
    		...
    		<div class="col-md-12" id="mainContent">
    			...
    			<form action="<?php echo site_url("backoffice/admin/deleteFiles");?>" method="post">
    			    	...
    			    	<tbody>
    			    		<?php foreach( $files as $file ):?>
    			      		...
    			      		<tr>
    			        		...
    			        		<td><b><a href="<?php echo base_url('backoffice')."uploads/".$file['name'];?>" target="_blank"><?php echo $file['name']?></a></b></td>
    			        		<td><?php echo date("Y-m-d", $file['date']);?></td>
    			        		<td><?php echo $file['size']?> <?php echo $this->lang->line('files_table_bytes')?></td>
    			        		<td>
    			        			<div class="crud">
    			        				<a href="<?php echo site_url("backoffice/admin/deleteFile/".$file['name']);?>" class="del"><span class="fui-cross-inverted text-danger del"></span></a>
    			        				&nbsp;
    			        				<a href="<?php echo base_url('backoffice')."uploads/".$file['name'];?>" target="_blank"><span class="fui-export"></span></a>
    			        			</div>
    			        		</td>
    			      		</tr>
    			      		<?php endforeach;?>
