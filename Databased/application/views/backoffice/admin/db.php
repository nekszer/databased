...
<body>
	...
	<?php $this->load->view("backoffice/shared/nav");?>
    		...
    		<div class="col-md-8 col-md-offset-2" id="mainContent">
    			...
    			<div class="tab-content">
    						...
    						<div class="panel panel-default">
    							...
    							<div id="db_<?php echo preg_replace("/[^A-Za-z0-9 ]/", '', $db['db']); ?>" class="panel-collapse collapse">
    						  		<div class="panel-body">
    						    		...
    						    		<a href="<?php echo site_url('backoffice/admin/deleteDB/'.$db['db']);?>" class="btn btn-danger btn-embossed deleteDB"><span class="fui-cross-inverted"></span> <?php echo $this->lang->line('admindb_deletedb_label')?></a>
    				...
    				<div class="tab-pane fade" id="CreateDBTab">
    					...
    					<form class="form-horizontal" role="form" action="<?php echo site_url('backoffice/admin/newDB');?>" method="post" id="newDBForm">
    ...
    <?php //$this->load->view("backoffice/users/includes/modal_newuser");?>
           	...
           	$('#dbAccordion').on("change", 'input.toggleDB', function(){
           		...
           		if( $(this).is(':checked') ) {
           			...
           			$.ajax({
           				type: "POST",
           				dataType: "json",
           				url: "<?php echo site_url('backoffice/admin/enableDB');?>/"+_theDB
           				...
           				//update main nav
           				$('#topNav .dbs').prepend($('<li class="db" id="'+_theDB+'"><a href="<?php echo site_url('backoffice/db/');?>/'+_theDB+'"><span class="fui-list"></span> '+_theDB+'</a></li>'));
           			...
           			$.ajax({
           				type: "POST",
           				dataType: "json",
           				url: "<?php echo site_url('backoffice/admin/disableDB');?>/"+_theDB
           			}).done(function(response){
