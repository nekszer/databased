      		...
      		<div class="modal-body">
      			...
      			<div class="tab-content">
     				...
     				<div class="tab-pane active" id="build">
     					...
     					<form class="form-horizontal" role="form" id="newTableForm" method="post" action="<?php echo site_url('backoffice/db/newTable/'.$theDB);?>">
    				...
    				<div class="tab-pane" id="import">
    					...
    					<div class="alert alert-info">
     					...
     					<form enctype="multipart/form-data" method="post" id="uploadForm" action="<?php echo site_url("backoffice/db/uploadCsv")?>">
