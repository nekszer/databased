    				...
    				<div class="panel panel-default">
    			    	...
    			    	<div id="db_<?php echo $db['db']?>" class="panel-collapse collapse">
    			      		<div class="panel-body">
    			      			...
    			      			<a href="<?php echo site_url('backoffice/db/'.$db['db']);?>" class="btn btn-primary btn-embossed btn-block"><span class="fui-new"></span> <?php echo $this->lang->line('dashboard_work_on_this_database')?></a>
    			      		</div>
    			    	</div>
    			  	</div><!-- /.panel -->
    			  	<?php endforeach;?>
    			  	...
    			  	<?php else:?>
    			  		...
    			  		<div class="alert alert-error">
    			  			<button type="button" class="close fui-cross" data-dismiss="alert"></button>
    			  	  		...
    			  	  		<a href="<?php echo site_url('backoffice/admin/db');?>" class="btn btn-info btn-wide"><?php echo $this->lang->line('dashboard_nodbs1_button')?></a>
    			  		</div>
    			  		<?php else:?>
    			  		<div class="alert alert-error">
    			  			<button type="button" class="close fui-cross" data-dismiss="alert"></button>
